...
export const likeComment = async (queryId, id, uid) => {
  await setDoc(doc(db, 'Prayers', queryId, 'comments', id, 'likes', uid), {
    uid
  })
}

export const removeLike = async (queryId, id, uid) => {
  await deleteDoc(doc(db, 'Prayers', queryId, 'comments', id, 'likes', uid))
}

export const dislikeComment = async (queryId, id, uid) => {
  await setDoc(doc(db, 'Prayers', queryId, 'comments', id, 'dislikes', uid), {
    uid
  })
}

export const removeDisLike = async (queryId, id, uid) => {
  await deleteDoc(doc(db, 'Prayers', queryId, 'comments', id, 'dislikes', uid))
}