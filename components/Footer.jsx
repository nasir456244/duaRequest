...
const Footer = () => {
  return (
    <div className={styles.container}>
      ...
      <a href="https://www.buymeacoffee.com/DuaRequest" target="_blank" className='hover:border-[#0ABEEE] mb-[20px] hover:text-[#0ABEEE] hover:border-b-2 hover:cursor-pointer'>Donate</a>
    </div>
  )
}
