...
const styles = {
    ...
    wallet: `bg-[#1c1852] flex justify-center items-center text-white rounded-2xl py-[2px] px-[2px] `,
    disconnectWallet: `text-xl bg-[#6b50c1] flex items-center p-[2px] rounded-2xl h-[50px] hover:bg-[#f50018] hover:text-[#fff]`,
