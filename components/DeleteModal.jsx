...
const styles = {
  container: `z-50 fixed w-full top-[390px] right-[0px]  flex justify-center items-center overflow-hidden`,
  modalContainer: `rounded-xl border border-2 border-gray-400 w-[350px] h-[170px] bg-[#fff] flex flex-col items-center justify-around`,
