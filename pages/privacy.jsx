    ...
    <div>
        ...
        <div className={styles.container}>
            <div className={styles.body}>
                ...
                Protecting your private information is our priority. This Statement of Privacy applies to https://duarequest.app and governs data collection and usage. We have developed this policy in order for you to understand how we collect, use, communicate and make use of personal information. The following outlines our privacy policy.
                ...
                <div>
                    ...
                    <li className='ml-4 '>DuaRequest undertakes to preserve the confidentiality of all information you provide to us, and hope that you reciprocate.</li>
                ...
                <li className='ml-4 '><b>Contact data,</b>such as your first and last name, and email address. </li>
                ...
                <p>DuaRequest may share data with trusted partners to help perform statistical analysis, send you email or postal mail, provide customer support, or arrange for deliveries. All such third parties are prohibited from using your personal information except to provide these services to DuaRequest, and they are required to maintain the confidentiality of your information.</p>
                ...
                <p>DuaRequest may aggregate this information in a general way and use it to provide class information, for example to monitor our performance with respect to a particular service we provide. If we use it for this purpose, you as an individual will not be personally identifiable. DuaRequest shall continue to process this information until the contract between us ends or is terminated by either party under the terms of the contract.</p>
                
                <p>Except where you have consented to our use of your information for a specific purpose, we do not use your information in any way that would identify you personally. DuaRequest may aggregate it in a general way and use it to provide class information, for example to monitor the performance of a particular page on our website.</p>
                
                <p>You may withdraw your consent at any time by instructing us (support@duarequest.app) However, if you do so, you may not be able to use our website or our services further</p>
                <h2 className='text-[19px] mb-4'>RETENTION PERIOD FOR PERSONAL DATA</h2>
                
                <p>Except as otherwise mentioned in this privacy notice, DuaRequest keeps your personal information only for as long as required by us:</p>
                ...
                <p>DuaRequest does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records. </p>
                
                <h2 className='text-[19px] mb-4'>INTELLECTUAL PROPERTY RIGHTS</h2>
                <p>All copyrights, trademarks, patents and other intellectual property rights in and on our website and all content and software located on the site shall remain the sole property of DuaRequest or its licensors. The use of our trademarks, content and intellectual property is forbidden without the express written consent from us.</p>
                ...
                <p>If you are not happy with our privacy policy or if any complaints, then you should tell us by email. Our e-mail address is support@duarequest.app.</p>
                
                <h2 className='text-[19px] mb-4'>REVIEW/MODIFICATION OF THIS PRIVACY POLICY</h2>
                
                <p>DuaRequest may update this privacy notice from time to time as necessary. The terms that apply to you are those posted here on our website on the day you use our website. We solely advise you to print a copy for your records.</p>
                
                <p>If you have any question regarding our privacy policy, please contact us through:</p>
                
                <p>E-mail:  support@duarequest.app</p>
                ...
                <p>Information about your computer hardware and software may be automatically collected by DuaRequest. This information can include: your IP address, browser type, domain names, access times and referring website addresses. This information is used for the operation of the service, to maintain quality of the service, and to provide general statistics regarding use of the https://duarequest.app website.</p>
                ...
                <p>DuaRequest uses this information in aggregate to assess the popularity of the webpages on our website and how we perform in providing content to you.</p>
                ...
                <p>Contact: support@duarequest.app</p>       
            </div>
        </div>
        <Footer />
    </div>
